...
impl CompletedPitchDiscriminationTrial {
    pub fn new(
        pitch_discrimination_trial: PitchDiscriminationTrial,
        user_answered_higher: bool,
        tuning_system: TuningSystem,
    ...
    pub fn pitch_discrimination_trial(&self) -> &PitchDiscriminationTrial {
        &self.pitch_discrimination_trial
    }
    ...
    pub fn is_correct(&self) -> bool {
        self.pitch_discrimination_trial
            .is_correct(self.user_answered_higher)
    }
}
...
mod tests {
    ...
    #[test]
    fn test_discrimination_trial_is_target_higher_positive_offset() {
    ...
    #[test]
    fn test_discrimination_trial_is_target_higher_negative_offset() {
        let comp = PitchDiscriminationTrial::new(
            MIDINote::new(60),
            DetunedMIDINote {
                note: MIDINote::new(60),
    ...
    #[test]
    fn test_discrimination_trial_is_target_higher_zero_offset() {
        let comp = PitchDiscriminationTrial::new(
            MIDINote::new(60),
            DetunedMIDINote {
                note: MIDINote::new(60),
    ...
    #[test]
    fn test_discrimination_trial_is_correct_user_right() {
        let comp = PitchDiscriminationTrial::new(
            MIDINote::new(60),
            DetunedMIDINote {
                note: MIDINote::new(60),
    ...
    #[test]
    fn test_discrimination_trial_is_correct_user_wrong() {
        let comp = PitchDiscriminationTrial::new(
            MIDINote::new(60),
            DetunedMIDINote {
                note: MIDINote::new(60),
    ...
    #[test]
    fn test_completed_discrimination_trial_incorrect() {
        let comp = PitchDiscriminationTrial::new(
            MIDINote::new(60),
            DetunedMIDINote {
                note: MIDINote::new(60),
    ...
    #[test]
    fn test_completed_discrimination_trial_getters() {
        let comp = PitchDiscriminationTrial::new(
            MIDINote::new(60),
            DetunedMIDINote {
                note: MIDINote::new(60),
        ...
        assert_eq!(*completed.pitch_discrimination_trial(), comp);
    ...
    #[test]
    fn test_discrimination_trial_serde_roundtrip() {
        let comp = PitchDiscriminationTrial::new(
            MIDINote::new(60),
            DetunedMIDINote {
                note: MIDINote::new(67),
        ...
        let parsed: PitchDiscriminationTrial = serde_json::from_str(&json).unwrap();
        assert_eq!(comp, parsed);
    }

    #[test]
    fn test_completed_discrimination_trial_serde_roundtrip() {
        let comp = PitchDiscriminationTrial::new(
            MIDINote::new(60),
            DetunedMIDINote {
                note: MIDINote::new(60),
        ...
        let parsed: CompletedPitchDiscriminationTrial = serde_json::from_str(&json).unwrap();
