...
value-percent-16th = { $value } % of 16th
unit-cents = cents
unit-percent-16th = % of 16th
...
fill-the-gap-experimental = Experimental. Works best with a wired input device. MIDI works better than a computer keyboard or mouse/trackpad.
tap = Tap
offset-ms = { $value } ms
...
progress-for = Progress for { $name }: { $ewma } { $unit }, { $trend }
progress-chart-for = Progress chart for { $name }
chart-today = Today
current-trend = Current: { $ewma } { $unit }, trend: { $trend }
...
spectrogram-level-excellent = Excellent
spectrogram-level-precise = Precise
spectrogram-level-moderate = Moderate
spectrogram-level-loose = Loose
spectrogram-level-erratic = Erratic
