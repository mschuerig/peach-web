...
pub fn StartPage() -> impl IntoView {
    view! {
        <div class="flex flex-col items-center gap-6 py-12">
            ...
            <nav class="flex gap-6 pt-4 text-sm">
                <A href="/settings"
                    attr:class="min-h-11 min-w-11 flex items-center justify-center rounded text-gray-600 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-400 dark:text-gray-400 dark:hover:text-gray-200">
                    "Settings"
                </A>
                <A href="/profile"
                    attr:class="min-h-11 min-w-11 flex items-center justify-center rounded text-gray-600 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-400 dark:text-gray-400 dark:hover:text-gray-200">
